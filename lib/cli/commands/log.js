...
module.exports = Command.extend({
	knownOptions: {'all': Boolean, 'clear': Boolean, 'flat': Boolean, 'boring': Boolean},
	knownShorthands: {'a': '--all', 'c': '--clear', 'f': '--flat', 'b': '--boring'},
	maxRemainingArgs: 0,
...
var formatLogFile = (function () {
	...
	return function (filename, options) {
		...
		if (options.boring) {title = clc.strip(title); contents = clc.strip(contents);}
